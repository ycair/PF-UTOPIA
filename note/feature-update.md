...
| 🌱 初始草原 | 🌊 沿海小徑 | 4 | 20 | |
| 🌱 初始草原 | 🍬 搗蛋精靈之森 | 3 | 15 | |
| 🌲 翡翠森林 | 😈 世界魔皇巢穴 | 8 | 50 | 死路，終局區域 |
| 🌲 翡翠森林 | 🏯 大士爺廟 | 4 | 20 | |
| 🌊 沿海小徑 | 🥏 寵物天堂 | 3 | 15 | |

#### 節點詳細

| 節點 | 類型 | 安全 | 對應系統 | 特色物資 | 怪物 |
|------|------|:----:|---------|---------|------|
| 🏰 主城 | capital | ✅ | 起點、商店、簽到 | 全物資基礎價 | — |
| 💣 競技場 | arena | ✅ | `/arena` | 骨頭、皮革 | 其他玩家 |
| 🎟 彩券中心 | town | ✅ | `/lottery_*` | — | — |
| 📊 投資交易所 | town | ✅ | `/market` `/invest_*` | — | — |
| ⛪ 女僕教堂 | sanctuary | ✅ | `/pray` `/meditate` | 線香、轉法輪 | — |
| 🌱 初始草原 | wild | ❌ | `/explore` 草原 | 黏液、羊毛（盛產） | 史萊姆、野雞、兔兔、綿羊、鹿、狼、野豬 |
| 🌲 翡翠森林 | wild | ❌ | `/explore` 森林 | 皮革、魔石、緞帶 | 猴子、蛇、哥布林、大蜥蜴、食人魔 |
